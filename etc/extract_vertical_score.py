...
##### Process #####
# 1. Read the image
# image = cv2.imread('/mnt/sdb/VSR_Inference/순풍_noise/lessdeg/00000488.tiff', cv2.IMREAD_GRAYSCALE)
# image = cv2.imread('/mnt/sdb/VSR_Inference/순풍_noise/lessdeg/00000488.tiff')
image = cv2.imread('/mnt/sdb/VSR_Inference/순풍_noise/new_deint/00000488.tiff')
...
print("here2",image_tensor.shape)
...
# cv2.imwrite('/mnt/sdb/VSR_Inference/순풍_noise/lessdeg/00000488_hori_blur.png', horizontal_blurred_image)
# cv2.imwrite('/mnt/sdb/VSR_Inference/순풍_noise/lessdeg/00000488_vertical_edge.png', vertical_edge_image)
# Save the results using OpenCV
cv2.imwrite('/mnt/sdb/VSR_Inference/순풍_noise/new_deint/00000488_hori_blur.png', horizontal_blurred_image)
cv2.imwrite('/mnt/sdb/VSR_Inference/순풍_noise/new_deint/00000488_vertical_edge.png', vertical_edge_image)
