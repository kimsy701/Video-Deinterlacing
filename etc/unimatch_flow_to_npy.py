...
def process_images_in_folder(folder_path,save_path, unimatch, threshold, magnitude, vertical_size):
...
if __name__ == '__main__':
    ...
    vertical_size = 4 #얼마나 median 취할지 radius
    ...
    process_images_in_folder(folder_path, save_path, unimatch, threshold, magnitude,vertical_size)
