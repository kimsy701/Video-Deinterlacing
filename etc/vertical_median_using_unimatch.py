...
if __name__ == '__main__':
    ...
    folder_path = '/mnt/sde/deinter_datasets/GCP_backup/deinter_dataset/qtgmc_winter_rst_twotime'  # Update this path
    save_path = f'/mnt/sde/deinter_datasets/GCP_backup/deinter_dataset/qtgmc_winter_rst_twotime_vertical_median_full_image_size{vertical_size}'
