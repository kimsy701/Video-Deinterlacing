...
# 이미지가 있는 폴더 경로
folder_path = 'C:/Users/인쇼츠/Desktop/Deinterlacing구현/inference_data/메디컬아일랜드/MI원본'
...
for img_idx, filename in enumerate(sorted(os.listdir(folder_path))):
    ...
    # 결과 이미지 파일로 저장
    output_folder = 'C:/Users/인쇼츠/Desktop/Deinterlacing구현/inference_data/메디컬아일랜드/MI_처리된'
    if not os.path.exists(output_folder):
        os.makedirs(output_folder)

    frame1_path = os.path.join(output_folder, f'processed_frame_{img_idx}_1.png')
    frame2_path = os.path.join(output_folder, f'processed_frame_{img_idx}_2.png')
